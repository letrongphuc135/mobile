    ...
    <div class="header-services">
      ...
      >
        <p class="ps-service">
          ...
          <strong>Free delivery</strong>: Get free standard delivery on every order with Sky Store
        </p>
        <p class="ps-service">
          <i class="ps-icon-delivery"></i>
          <strong>Free delivery</strong>: Get free standard delivery on every order with Sky Store
            ...
            <div class="col-lg-10 col-md-12 col-lg-offset-1">
              <div class="ps-product__thumbnail">
                <div class="ps-product__preview">
                  <div class="ps-product__variants" v-for="(productdetail, index) in productDetail" :key="index">
                    <div class="item">
                      <img 
                      :src="productdetail.product_img" alt />
                    </div>
                  </div>
                  <a
                    class="popup-youtube ps-product__video"
                    href="http://www.youtube.com/watch?v=0O2aH4XLbto"
                  >
                    <img src="assets/customer/images/shoe-detail/1.jpg" alt />
                ...
                <div class="ps-product__image">
                  <div class="item">
                    <img
                      class="zoom"
                      src="assets/customer/images/shoe-detail/1.jpg"
                      alt
                  ...
                  <div class="item">
                    <img
                      class="zoom"
                      src="assets/customer/images/shoe-detail/2.jpg"
                      alt
                  ...
                  <div class="item">
                    <img
                      class="zoom"
                      src="assets/customer/images/shoe-detail/3.jpg"
                      alt
                  ...
                  <ul>
                    <li>
                      <a href="product-detail.html">
                        <img src="assets/customer/images/shoe/sidebar/1.jpg" alt />
                      </a>
                    </li>
                    <li>
                      <a href="product-detail.html">
                        <img src="assets/customer/images/shoe/sidebar/2.jpg" alt />
                      </a>
                    </li>
                    <li>
                      <a href="product-detail.html">
                        <img src="assets/customer/images/shoe/sidebar/3.jpg" alt />
                      </a>
                    </li>
                    <li>
                      <a href="product-detail.html">
                ...
                <div class="tab-pane" role="tabpanel" id="tab_02">
                  ...
                  <div class="ps-review">
                    <div class="ps-review__thumbnail">
                      <img src="assets/customer/images/user/1.jpg" alt />
                    </div>
                    <div class="ps-review__content">
                      <header>
                        ...
                        <p>
                          By
                          <a href>Alena Studio</a> - November 25, 2017
                        </p>
                      </header>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    ...
                    <img src="assets/customer/images/shoe/1.jpg" alt />
                    <a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal">
                        <img src="assets/customer/images/shoe/2.jpg" alt />
                        <img src="assets/customer/images/shoe/3.jpg" alt />
                        <img src="assets/customer/images/shoe/4.jpg" alt />
                        <img src="assets/customer/images/shoe/5.jpg" alt />
                      </div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    ...
                    <img src="assets/customer/images/shoe/6.jpg" alt />
                    <a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
