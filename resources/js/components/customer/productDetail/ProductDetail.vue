                    ...
                    <div class="row">
                        <div class="col-lg-10 col-md-12 col-lg-offset-1">
                            <div class="ps-product__thumbnail">
                                <div class="ps-product__preview">
                                    <div class="ps-product__variants">
                                       <div class="item" v-for="(image_pro, index) in productDetail.product_img" :key="index"><img :src="image_pro.url" alt=""></div>
                                    </div>
                                </div>
                                <div class="ps-product__image">
                                    <div class="item"><img class="zoom" :src="image_pro.url" alt="" :data-zoom-image="image_pro.url"></div>
                                </div>
                            </div>
                            <div class="ps-product__thumbnail--mobile">
                               <div class="ps-product__main-img" v-for="(image_pro, index) in productDetail.product_img" :key="`${index}-${image_pro.id}`" :class="image_pro.name"><img :src="image_pro.url" alt=""></div>
                                <div class="ps-product__preview owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="20" data-owl-nav="true" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="4" data-owl-item-sm="4" data-owl-item-md="4" data-owl-item-lg="4" data-owl-duration="1000" data-owl-mousedrag="on" v-for="(image_pro, index) in productDetail.product_img" :key="index"><img :src="image_pro.url" alt=""></div>
                            </div>
                            <div class="ps-product__info">
                                ...
                                <p class="ps-product__category"><a href="#">{{productDetail.category.name}} , </a><a href="#">{{productDetail.product_type.name}}</a></p>
                                <h3 class="ps-product__price" v-if="productDetail.promotion == 0">{{productDetail.price}}</h3>
                                <h3 class="ps-product__price" v-else>{{productDetail.promotion}} <del>{{productDetail.price}}</del></h3>
