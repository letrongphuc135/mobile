                    ...
                    <section class="product-shop spad">
                        <div class="container">
                                <!--<div id="columns" class="columns_4">-->
                                    <isotope ref="cpt" id="root_isotope1"
                                    ...
                                    <!--<isotope ref="cpt" id="root_isotope1" class="abc"-->
                                             <!--:item-selector="'filter-item'" :list="products"-->
                                             <!--:options='option'>-->

                                        <!--<figure v-for="(element,index) in products"-->
                                                <!--:class='[element.product_type.name]' :key="index" style="top: 510px">-->
