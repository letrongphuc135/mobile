...
<head>
    ...
    <link rel="stylesheet" href="assets/customer/plugins/jquery-bar-rating/dist/themes/fontawesome-stars.css">
  ...
  <body>
                  ...
                  <div class="header__actions"><a href="#">Login & Regiser</a>
                    <div class="btn-group ps-dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">USD<i class="fa fa-angle-down"></i></a>
                      <ul class="dropdown-menu">
                        <li><a href="#"><img src="assets/customer/images/flag/usa.svg" alt=""> USD</a></li>
                        <li><a href="#"><img src="assets/customer/images/flag/singapore.svg" alt=""> SGD</a></li>
                        <li><a href="#"><img src="assets/customer/images/flag/japan.svg" alt=""> JPN</a></li>
                      </ul>
                    </div>
      ...
      <nav class="navigation">
        <div class="container-fluid">
          <div class="navigation__column left">
            <div class="header__logo"><a class="ps-logo" href="index.html"><img src="assets/customer/images/logo.png" alt=""></a></div>
          </div>
              ...
              <div class="ps-cart__listing">
                <div class="ps-cart__content">
                  <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                    <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img src="assets/customer/images/cart-preview/1.jpg" alt=""></div>
                    <div class="ps-cart-item__content"><a class="ps-cart-item__title" href="product-detail.html">Amazin’ Glazin’</a>
                      <p><span>Quantity:<i>12</i></span><span>Total:<i>£176</i></span></p>
                    </div>
                  </div>
                  <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                    <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img src="assets/customer/images/cart-preview/2.jpg" alt=""></div>
                    <div class="ps-cart-item__content"><a class="ps-cart-item__title" href="product-detail.html">The Crusty Croissant</a>
                      <p><span>Quantity:<i>12</i></span><span>Total:<i>£176</i></span></p>
                    </div>
                  </div>
                  <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                    <div class="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img src="assets/customer/images/cart-preview/3.jpg" alt=""></div>
    ...
    <main class="ps-main">
            ...
            <div class="col-lg-10 col-md-12 col-lg-offset-1">
              <div class="ps-product__thumbnail">
                <div class="ps-product__preview">
                  <div class="ps-product__variants">
                    <div class="item"><img src="assets/customer/images/shoe-detail/1.jpg" alt=""></div>
                    <div class="item"><img src="assets/customer/images/shoe-detail/2.jpg" alt=""></div>
                    <div class="item"><img src="assets/customer/images/shoe-detail/3.jpg" alt=""></div>
                    <div class="item"><img src="assets/customer/images/shoe-detail/3.jpg" alt=""></div>
                    <div class="item"><img src="assets/customer/images/shoe-detail/3.jpg" alt=""></div>
                  </div><a class="popup-youtube ps-product__video" href="http://www.youtube.com/watch?v=0O2aH4XLbto"><img src="assets/customer/images/shoe-detail/1.jpg" alt=""><i class="fa fa-play"></i></a>
                </div>
                <div class="ps-product__image">
                  <div class="item"><img class="zoom" src="assets/customer/images/shoe-detail/1.jpg" alt="" data-zoom-image="images/shoe-detail/1.jpg"></div>
                  <div class="item"><img class="zoom" src="assets/customer/images/shoe-detail/2.jpg" alt="" data-zoom-image="images/shoe-detail/2.jpg"></div>
                  <div class="item"><img class="zoom" src="assets/customer/images/shoe-detail/3.jpg" alt="" data-zoom-image="images/shoe-detail/3.jpg"></div>
                </div>
              </div>
              <div class="ps-product__thumbnail--mobile">
                <div class="ps-product__main-img"><img src="assets/customer/images/shoe-detail/1.jpg" alt=""></div>
                <div class="ps-product__preview owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="20" data-owl-nav="true" data-owl-dots="false" data-owl-item="3" data-owl-item-xs="3" data-owl-item-sm="3" data-owl-item-md="3" data-owl-item-lg="3" data-owl-duration="1000" data-owl-mousedrag="on"><img src="assets/customer/images/shoe-detail/1.jpg" alt=""><img src="assets/customer/images/shoe-detail/2.jpg" alt=""><img src="assets/customer/images/shoe-detail/3.jpg" alt=""></div>
              </div>
              <div class="ps-product__info">
                ...
                <div class="ps-product__block ps-product__style">
                  ...
                  <ul>
                    <li><a href="product-detail.html"><img src="assets/customer/images/shoe/sidebar/1.jpg" alt=""></a></li>
                    <li><a href="product-detail.html"><img src="assets/customer/images/shoe/sidebar/2.jpg" alt=""></a></li>
                    <li><a href="product-detail.html"><img src="assets/customer/images/shoe/sidebar/3.jpg" alt=""></a></li>
                    <li><a href="product-detail.html"><img src="assets/customer/images/shoe/sidebar/2.jpg" alt=""></a></li>
                  </ul>
                </div>
              ...
              <div class="tab-content mb-60">
                ...
                <div class="tab-pane" role="tabpanel" id="tab_02">
                  ...
                  <div class="ps-review">
                    <div class="ps-review__thumbnail"><img src="assets/customer/images/user/1.jpg" alt=""></div>
          ...
          <div class="ps-section__content">
            <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-duration="1000" data-owl-mousedrag="on">
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="assets/customer/images/shoe/1.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="assets/customer/images/shoe/2.jpg" alt=""><img src="assets/customer/images/shoe/3.jpg" alt=""><img src="assets/customer/images/shoe/4.jpg" alt=""><img src="assets/customer/images/shoe/5.jpg" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    ...
                    <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="assets/customer/images/shoe/2.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="assets/customer/images/shoe/2.jpg" alt=""><img src="assets/customer/images/shoe/3.jpg" alt=""><img src="assets/customer/images/shoe/4.jpg" alt=""><img src="assets/customer/images/shoe/5.jpg" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="assets/customer/images/shoe/3.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="assets/customer/images/shoe/2.jpg" alt=""><img src="assets/customer/images/shoe/3.jpg" alt=""><img src="assets/customer/images/shoe/4.jpg" alt=""><img src="assets/customer/images/shoe/5.jpg" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="assets/customer/images/shoe/6.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="assets/customer/images/shoe/2.jpg" alt=""><img src="assets/customer/images/shoe/3.jpg" alt=""><img src="assets/customer/images/shoe/4.jpg" alt=""><img src="assets/customer/images/shoe/5.jpg" alt=""></div>
      ...
      <div class="ps-footer bg--cover" data-background="assets/customer/images/background/parallax.jpg">
        <div class="ps-footer__content">
          <div class="ps-container">
            <div class="row">
                  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                    <aside class="ps-widget--footer ps-widget--info">
                      <header><a class="ps-logo" href="index.html"><img src="assets/customer/images/logo-white.png" alt=""></a>
...
<script type="text/javascript"
        src="assets/customer/plugins/jquery-bar-rating/dist/jquery.barrating.min.js"></script>
<script type="text/javascript"
        src="assets/customer/plugins/owl-carousel/owl.carousel.min.js"></script>
<script type="text/javascript" src="assets/customer/plugins/gmap3.min.js"></script>
{{--<script type="text/javascript" src="assets/customer/plugins/imagesloaded.pkgd.js"></script>--}}
<script type="text/javascript" src="assets/customer/plugins/isotope.pkgd.min.js"></script>
<script type="text/javascript"
        src="assets/customer/plugins/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
<script type="text/javascript" src="assets/customer/plugins/jquery.matchHeight-min.js"></script>
<script type="text/javascript" src="assets/customer/plugins/slick/slick/slick.min.js"></script>
<script type="text/javascript"
        src="assets/customer/plugins/elevatezoom/jquery.elevatezoom.js"></script>
<script type="text/javascript"
        src="assets/customer/plugins/Magnific-Popup/dist/jquery.magnific-popup.min.js"></script>
<script type="text/javascript" src="assets/customer/plugins/jquery-ui/jquery-ui.min.js"></script>
<script type="text/javascript"
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAx39JFH5nhxze1ZydH-Kl8xXM3OK4fvcg&amp;region=GB"></script>
<script type="text/javascript" src="assets/customer/plugins/revolution/js/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript"
        src="assets/customer/plugins/revolution/js/jquery.themepunch.revolution.min.js"></script>
<script type="text/javascript"
        src="assets/customer/plugins/revolution/js/extensions/revolution.extension.video.min.js"></script>
<script type="text/javascript"
        src="assets/customer/plugins/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script type="text/javascript"
        src="assets/customer/plugins/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script type="text/javascript"
        src="assets/customer/plugins/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script type="text/javascript"
        src="assets/customer/plugins/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script type="text/javascript"
